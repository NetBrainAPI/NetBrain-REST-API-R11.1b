...
|incident_setting|object|create incident for task if not null.<br>If the option parameter is set, it means that the TAF (Triggered Automation Framework) logic is involved, and the incident_setting parameter will be invalid.|
